      ...
      {items.map((item) => {
        ...
        return (
          <motion.div
            ...
            className="rounded-xl border border-border bg-background p-7 shadow-soft transition-[box-shadow,border-color] duration-base ease-out-soft hover:border-accent/40 hover:shadow-glow"
          >
